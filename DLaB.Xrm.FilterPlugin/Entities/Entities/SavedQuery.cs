...
namespace DLaB.Xrm.FilterPlugin.Entities
{
	...
	public partial class SavedQuery : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<DLaB.Xrm.FilterPlugin.Entities.SavedQueryState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((DLaB.Xrm.FilterPlugin.Entities.SavedQueryState)(System.Enum.ToObject(typeof(DLaB.Xrm.FilterPlugin.Entities.SavedQueryState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public DLaB.Xrm.FilterPlugin.Entities.SystemUser lk_savedquery_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DLaB.Xrm.FilterPlugin.Entities.SystemUser>("lk_savedquery_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_savedquery_createdonbehalfby");
				this.SetRelatedEntity<DLaB.Xrm.FilterPlugin.Entities.SystemUser>("lk_savedquery_createdonbehalfby", null, value);
		...
		public DLaB.Xrm.FilterPlugin.Entities.SystemUser lk_savedquery_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DLaB.Xrm.FilterPlugin.Entities.SystemUser>("lk_savedquery_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_savedquery_modifiedonbehalfby");
				this.SetRelatedEntity<DLaB.Xrm.FilterPlugin.Entities.SystemUser>("lk_savedquery_modifiedonbehalfby", null, value);
		...
		public DLaB.Xrm.FilterPlugin.Entities.SystemUser lk_savedquerybase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DLaB.Xrm.FilterPlugin.Entities.SystemUser>("lk_savedquerybase_createdby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_savedquerybase_createdby");
				this.SetRelatedEntity<DLaB.Xrm.FilterPlugin.Entities.SystemUser>("lk_savedquerybase_createdby", null, value);
		...
		public DLaB.Xrm.FilterPlugin.Entities.SystemUser lk_savedquerybase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DLaB.Xrm.FilterPlugin.Entities.SystemUser>("lk_savedquerybase_modifiedby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_savedquerybase_modifiedby");
				this.SetRelatedEntity<DLaB.Xrm.FilterPlugin.Entities.SystemUser>("lk_savedquerybase_modifiedby", null, value);
